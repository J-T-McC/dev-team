...
## Responsibilities
- Produce one task plan per technical plan from `templates/task-plan.md` into `docs/tasks/`
...
## Required documents
`CLAUDE.md`, the technical plan, the PRD, `templates/task-plan.md`, `docs/standards/planning.md`
...
## Example
See `docs/tasks/user-authentication-tasks.md` — five tasks with explicit files and testable criteria. T3 (register endpoint) depends on T1 (users table) and T2 (password hashing); nothing depends on a later task.
