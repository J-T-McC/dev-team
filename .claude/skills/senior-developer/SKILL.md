...
## Example
Implementing T2 (password hashing) from `docs/tasks/user-authentication-tasks.md`: touch only the listed files, match the plan's `PasswordHasher` interface, and write unit tests for hash/verify round-trip and sub-10-character rejection — nothing more.
