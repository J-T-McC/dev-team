...
if [ -f "${CLAUDE_PROJECT_DIR:-.}/docs/status.md" ]; then
  echo "dev-team plugin active. Workspace: docs/ (status: docs/status.md). Delegate feature work to the dev-team agents: orchestrator, product-manager, principal-engineer, task-planner, senior-developer, reviewer."
else
